...
# 引入 env.py 文件
# from env import JUEJIN_COOKIE, JUEJIN_SENDKEY, JUEJIN_DATA;
# # 设置环境变量
# os.environ["JUEJIN_COOKIE"] = JUEJIN_COOKIE;
# os.environ["JUEJIN_SENDKEY"] = JUEJIN_SENDKEY;
# os.environ["JUEJIN_DATA"] = JUEJIN_DATA;
...
def _request(cookie, data, SENDKEY):
    ...
    msg += "\n\n来个图片\n\n![screenshot](https://api.yoke0104.com/api/dou)"
...
if __name__ == "__main__":
    print("掘金签到： " + JueJin());
    # 每天8点执行一次
    # schedule.every().day.at("08:00").do(Juejin);
    # while True:
